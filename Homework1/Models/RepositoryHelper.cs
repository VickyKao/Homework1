namespace Homework1.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_ClientInfoRepository Getvw_ClientInfoRepository()
		{
			var repository = new vw_ClientInfoRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_ClientInfoRepository Getvw_ClientInfoRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_ClientInfoRepository();
